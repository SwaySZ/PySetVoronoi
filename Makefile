...
obj/cellmachine.o: src/CellMachine.*
		$(CXX) -c -o obj/cellmachine.o src/CellMachine.cpp
#obj/ray.o: src/ray.*
...
LINK: obj/main.o obj/voro.o obj/fileloader.o obj/pointpattern.o obj/cellmachine.o
	$(CXX) obj/main.o obj/voro.o obj/fileloader.o obj/pointpattern.o obj/cellmachine.o -o bin/pomelo -L./lib/Lua/ -llua -lm -ldl
