 ...
 */
const int init_n_vertices=64;//8
...
const unsigned long long max_delete_size=16777216*64;
/** The maximum size for the auxiliary delete stack. */
const unsigned long long max_delete2_size=16777216*64;
